                    ...
                    <tr>
                        ...
                        <td>
                            <label for="Tabungan">Tabungan: </label>
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" name="Tabungan" id="Tabungan" min="1" required>
                                </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="Lainnya">Lainnya: </label>
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" name="Lainnya" id="Lainnya" min="1" required>
                                </div>
                        </td>
